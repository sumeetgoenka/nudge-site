  ...
  return (
    <section className="relative py-32 border-t border-white/5">
      <div className="max-w-4xl mx-auto px-6 text-center">
        <h2 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-6">{d.cta.title}</h2>
        <p className="text-lg text-white/60 max-w-xl mx-auto mb-10">{d.cta.subtitle}</p>
        <a
        ...
        <p className="mt-4 text-xs text-white/40">{d.cta.requirement}</p>
      </div>
    </section>
  );
}
